...
/usr/bin/git add top5_by_population_confirmed.csv
/usr/bin/git add top5_by_population_deaths.csv
/usr/bin/git add top5_by_population_grow_percent_confirmed.csv
/usr/bin/git add top5_by_population_grow_percent_deaths.csv
/usr/bin/git add top5_total_confirmed.csv
/usr/bin/git add top5_total_deaths.csv
/usr/bin/git add top5_total_grow_percent_confirmed.csv
/usr/bin/git add top5_total_grow_percent_deaths.csv
